...
describe("HomeView", () => {
  ...
  it("renders up state with facts, 15 tiles, and status summary", () => {
    ...
    expect(screen.getAllByRole("button", { name: /^Open / })).toHaveLength(15);
    expect(screen.getByText("1 running, 13 available, 1 disabled")).toBeInTheDocument();
  });
